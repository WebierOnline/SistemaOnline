...
Begin VB.Form REL_Recibo_Avulso 
   ...
   ClientTop       =   330
   ClientWidth     =   12075
   Icon            =   "REL_Recibo_Avulso.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   110.861
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      _ExtentY        =   10107
      Ordem           =   1
      Begin ReportX.ReportField txtDataPgto 
         Height          =   210
         Left            =   1620
         TabIndex        =   17
         Top             =   5310
      ...
      Begin ReportX.ReportField ReportField47 
         ...
         AlturaLivre     =   -1  'True
      End
      Begin ReportX.ReportField ReportField48 
         Height          =   480
         Left            =   240
         TabIndex        =   4
         Top             =   4140
      ...
      Begin ReportX.ReportField txtCliente 
         ...
         AlinhamentoVertical=   1
      End
      Begin ReportX.ReportField txtProveniente 
         Height          =   600
         Left            =   2340
         TabIndex        =   6
         Top             =   4140
      ...
      Begin ReportX.ReportField ReportField1 
         ...
         _ExtentX        =   15690
         _ExtentY        =   1111
         Caption         =   "R E C I B O  D E  P A G A M E N T O"
         Alignment       =   2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial Black"
            Size            =   15.75
   ...
   End
End
Attribute VB_Name = "REL_Recibo_Avulso"
