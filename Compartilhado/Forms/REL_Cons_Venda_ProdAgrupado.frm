...
Begin VB.Form REL_Cons_Venda_ProdAgrupado 
   ...
   ClientTop       =   330
   ClientWidth     =   12570
   Icon            =   "REL_Cons_Venda_ProdAgrupado.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   80.698
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      Begin VB.Label lblTitulo 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "RELATÓRIO DE VENDAS POR PRODUTOS AGRUPADOS"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   14.25
            Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   1650
      Left            =   0
      Picture         =   "REL_Cons_Venda_ProdAgrupado.frx":030A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1725
   End
End
Attribute VB_Name = "REL_Cons_Venda_ProdAgrupado"
