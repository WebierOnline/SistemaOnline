...
'
Public Function parseJSON(ByRef str As String) As Object
   ...
   Select Case Mid(str, index, 1)
      Case "{"
         Set parseJSON = parseObject(str, index)
      Case "["
         Set parseJSON = parseArray(str, index)
      Case Else
...
'   parse string and create JSON object
'
Public Function parse2(ByRef str As String) As Object
   ...
   Select Case Mid(str, index, 1)
      Case "{"
         Set parse2 = parseObject(str, index)
      Case "["
         Set parse2 = parseArray(str, index)
      Case Else
         psErrors = "Invalid JSON"
   End Select
