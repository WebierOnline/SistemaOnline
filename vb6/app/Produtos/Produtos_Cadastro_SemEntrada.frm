...
Begin VB.Form Produtos_Cadastro_SemEntrada 
   ...
   ClientTop       =   330
   ClientWidth     =   13920
   Icon            =   "Produtos_Cadastro_SemEntrada.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   10140
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   645
         Left            =   480
         Picture         =   "Produtos_Cadastro_SemEntrada.frx":23D2
         Top             =   120
         Width           =   645
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "Produtos_Cadastro_SemEntrada.frx":7DA5
      ...
      TabPicture(1)   =   "Produtos_Cadastro_SemEntrada.frx":7DC1
      ...
      TabPicture(2)   =   "Produtos_Cadastro_SemEntrada.frx":7DDD
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":7DF9
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":7E15
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExcluir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":86EF
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":870B
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSalvar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":8A25
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":8A41
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   4
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":F30B
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":F327
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   4
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":15DCB
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":15DE7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":16AC1
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":16ADD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExibir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":16DF7
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":16E13
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdImprimir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":176ED
         PICN            =   "Produtos_Cadastro_SemEntrada.frx":17709
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton CmdHabilitar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Produtos_Cadastro_SemEntrada.frx":17A23
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Produtos_Cadastro_SemEntrada"
...
Private Sub Entrada_Estoque()
   ...
   sSQL = "INSERT INTO produtos_entrada_itens (" & _
      "codigo, codigo_entrada, CODIGO_PRODUTO, DESCRICAO, QUANT, CUSTO, " & _
      "IMPOSTO_VALOR_COMPRA, FRETE, CUSTO_COMPRA, LUCRO_VALOR, IMPOSTO_VALOR_VENDA, " & _
      "VENDA, IMPOSTO_COMPRA, IMPOSTO_STATUS_COMPRA, LUCRO, LUCRO_STATUS, " & _
      "IMPOSTO_VENDA, IMPOSTO_STATUS_VENDA) VALUES (" & _
      var_COD_ITENS & ", '0001', " & txtCodigo.Text & ", '" & txtDescricao.Text & "', " & _
      Replace(CDbl(txtQuant.Text), ",", ".") & ", " & Replace(CCur(txtValorAtual.Text), ",", ".") & ", " & _
   ...
   'dbData.Execute "UPDATE produtos SET quant_estoque = " & Replace(txtQuant.Text, ",", ".") & " WHERE (codigo = " & txtCodigo.Text & ");"
End Sub
