...
Begin VB.Form NFe_Observacoes 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "NFe - Observações da NFe"
   ClientHeight    =   4725
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10860
   Icon            =   "NFe_Observacoes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4725
   ...
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Observacoes.frx":23D2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Observacoes.frx":23EE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Observacoes.frx":240A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Observacoes.frx":2426
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "NFe_Observacoes"
...
Private Function Inserir_Dados() As Boolean
   ...
   'Comando de inclusão
   sSQL = "INSERT INTO ObservacoesNFe (CodigoObservacao, Observacao) VALUES (" & txtCodigo.Text & ", '" & txtObservao.Text & "');"
...
Private Function Atualizar_Dados() As Boolean
   ...
   sSQL = "UPDATE ObservacoesNFe SET Observacao = '" & txtObservao.Text & "' WHERE (CodigoObservacao = " & txtCodigo.Text & ");"
...
Private Sub Auto_Numeracao()
   sSQL = "SELECT ISNULL(MAX(CodigoObservacao), 0) AS cod FROM ObservacoesNFe;"
...
Private Sub Exibir_Observacao()

sSQL = "SELECT CodigoObservacao, Observacao FROM ObservacoesNFe;"
Set r = dbData.OpenRecordset(sSQL)

FormatarGrid_Observacao r

If r.State <> 0 Then r.Close
Set r = Nothing
End Sub

Private Sub FormatarGrid_Observacao(rTabela As ADODB.Recordset)
Dim i As Integer
...
With Grid
   ...
   If Not rTabela Is Nothing Then
      Do While Not rTabela.EOF
         .TextMatrix(.Rows - 1, 1) = rTabela("CodigoObservacao")
         .TextMatrix(.Rows - 1, 2) = rTabela("Observacao")
...
Private Sub txtObservao_KeyPress(KeyAscii As Integer)
   KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub cmdAlterar_Click()
If txtCodigo.Text = "" Or txtObservao.Text = "" Then Exit Sub
...
'sSQL = "SELECT * FROM ObservacoesNFe WHERE (CodigoObservacao = " & txtCodigo.Text & ");"
'Set r = dbData.OpenRecordset(sSQL)

'Faz a exclusão usando o comando DELETE do SQL
sSQL = "DELETE FROM ObservacoesNFe WHERE (CodigoObservacao = " & txtCodigo.Text & ");"
...
Private Sub Grid_DblClick()
   ...
   txtObservao.Text = (Grid.TextMatrix(Grid.Row, 2))
