...
Begin VB.Form OS_Automoveis 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(1)=   "frmSecundario"
      Tab(0).Control(2)=   "Picture14"
      Tab(0).Control(3)=   "frmPrincipal"
      Tab(0).Control(4)=   "cmdImprimirEntrada"
      Tab(0).Control(5)=   "cmdGerarEntrada"
      Tab(0).Control(6)=   "cmdAlterar"
      Tab(0).Control(7)=   "cmdApagar"
      Tab(0).Control(8)=   "cmdNovo"
      Tab(0).Control(9)=   "cmdCancelarEntrada"
      Tab(0).Control(10)=   "cmdCadastrarAcessorios"
      Tab(0).Control(11)=   "cmdCadastrarCliente"
      Tab(0).Control(12)=   "cmdGarantia"
      Tab(0).Control(13)=   "chameleonButton1"
