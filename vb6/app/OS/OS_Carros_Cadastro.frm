...
Begin VB.Form OS_Carros_Cadastro 
   ...
   ClientTop       =   330
   ClientWidth     =   7320
   Icon            =   "OS_Carros_Cadastro.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7605
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image imgCarro 
         Height          =   900
         Left            =   300
         Picture         =   "OS_Carros_Cadastro.frx":23D2
         Top             =   60
         Width           =   1065
      End
      Begin VB.Image imgMoto 
         Height          =   1185
         Left            =   120
         Picture         =   "OS_Carros_Cadastro.frx":2C1A
         Top             =   -60
         Width           =   1395
      End
   ...
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "OS_Carros_Cadastro.frx":4146
      PICN            =   "OS_Carros_Cadastro.frx":4162
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "OS_Carros_Cadastro.frx":52AC
      PICN            =   "OS_Carros_Cadastro.frx":52C8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "OS_Carros_Cadastro.frx":5BA2
      PICN            =   "OS_Carros_Cadastro.frx":5BBE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "OS_Carros_Cadastro.frx":5ED8
      PICN            =   "OS_Carros_Cadastro.frx":5EF4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdFechar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "OS_Carros_Cadastro.frx":6BCE
      PICN            =   "OS_Carros_Cadastro.frx":6BEA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "OS_Carros_Cadastro"
