...
Begin VB.Form OS_Grafica 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "OS_Grafica.frx":2939
      ...
      TabPicture(1)   =   "OS_Grafica.frx":2955
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "lblValidade"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "cmdNovo"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "cmdGerarEntrada"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "cmdApagar"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "cmdAlterar"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "cmdCancelarEntrada"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "frmPrincipal"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "frmSecundario"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).ControlCount=   8
      TabCaption(2)   =   "SERVIÇOS"
      TabPicture(2)   =   "OS_Grafica.frx":2971
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "Picture1"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "PEÇAS"
      TabPicture(3)   =   "OS_Grafica.frx":298D
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "frmPecas"
      Tab(3).Control(1)=   "Picture19"
      Tab(3).Control(2)=   "cmdPecas"
      Tab(3).Control(3)=   "Grid_Pecas"
      Tab(3).Control(4)=   "cmdRemoverPecas"
      Tab(3).Control(5)=   "cmdAdicionarPecas"
      Tab(3).Control(6)=   "lblTotalPeca"
      Tab(3).ControlCount=   7
      TabCaption(4)   =   " PGTO"
      TabPicture(4)   =   "OS_Grafica.frx":29A9
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "frmVendaAvista"
      Tab(4).Control(1)=   "frmVendaPrazo"
      Tab(4).Control(2)=   "cmdFinalizarAV"
      Tab(4).Control(3)=   "cmdFinalizarAP"
      Tab(4).ControlCount=   4
      TabCaption(5)   =   " CONSULTA"
      TabPicture(5)   =   "OS_Grafica.frx":29C5
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "lblQuant"
      Tab(5).Control(1)=   "lblQuantFiltro"
      Tab(5).Control(2)=   "Grid"
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin ChamaleonBtn.chameleonButton cmdServicos 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "OS_Grafica.frx":2A6D
            PICN            =   "OS_Grafica.frx":2A89
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.PictureBox frmPrincipal 
         ...
         Begin ChamaleonBtn.chameleonButton chameleonButton1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "OS_Grafica.frx":2FA9
            PICN            =   "OS_Grafica.frx":2FC5
            PICH            =   "OS_Grafica.frx":5318
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdCal1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "OS_Grafica.frx":766B
            PICN            =   "OS_Grafica.frx":7687
            PICH            =   "OS_Grafica.frx":99DA
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   -74880
         TabIndex        =   7
         Text            =   "ULTIMAS ORDENS DE SERVIÇOS"
         Top             =   480
         Width           =   11055
      End
      ...
      Begin ChamaleonBtn.chameleonButton cmdPecas 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":BD65
         PICN            =   "OS_Grafica.frx":BD81
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelarEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":C27D
         PICN            =   "OS_Grafica.frx":C299
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":E02B
         PICN            =   "OS_Grafica.frx":E047
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdApagar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":FDD9
         PICN            =   "OS_Grafica.frx":FDF5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdGerarEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":11B87
         PICN            =   "OS_Grafica.frx":11BA3
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Grafica.frx":13935
         PICN            =   "OS_Grafica.frx":13951
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
...
varTIPO_OS = " (os.tipo_os <> 'TODOS') "
   SITUACAO = ""
   var_STATUS = ""
   sSQL = "SELECT cliente.*, os.status AS var_status, os.* " & _
...
Private Sub FormatarGrid_OS_Situacao(rTabela As ADODB.Recordset)
   ...
   With Grid_OS
      ...
      .FormatString = "^CÓD.|^TECNICO|^CLIENTE|^ENTRADA"
      .ColWidth(0) = 650
      .ColWidth(1) = 1800
      .ColWidth(2) = 6000
      '.ColWidth(3) = 3000
      ...
      If Not rTabela Is Nothing Then
         Do While Not rTabela.EOF
            ...
            .TextMatrix(.Rows - 1, 3) = Format(rTabela("DATA_ENTRADA"), "dd/mm/yy") & " - " & Format(rTabela("HORA_ENTRADA"), ocHRMN)
            rTabela.MoveNext
         Loop
      End If
