...
Begin VB.Form OS_CAD_Servicos_Geral 
   ...
   ClientTop       =   330
   ClientWidth     =   8145
   Icon            =   "OS_CAD_Servicos_Geral.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6225
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   120
         Picture         =   "OS_CAD_Servicos_Geral.frx":23D2
         Top             =   45
         Width           =   900
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "OS_CAD_Servicos_Geral.frx":28A9
      ...
      TabPicture(1)   =   "OS_CAD_Servicos_Geral.frx":28C5
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":28E1
         PICN            =   "OS_CAD_Servicos_Geral.frx":28FD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":468F
         PICN            =   "OS_CAD_Servicos_Geral.frx":46AB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExcluir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":643D
         PICN            =   "OS_CAD_Servicos_Geral.frx":6459
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSalvar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":81EB
         PICN            =   "OS_CAD_Servicos_Geral.frx":8207
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":9F99
         PICN            =   "OS_CAD_Servicos_Geral.frx":9FB5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_CAD_Servicos_Geral.frx":BD47
         PICN            =   "OS_CAD_Servicos_Geral.frx":BD63
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "OS_CAD_Servicos_Geral"
