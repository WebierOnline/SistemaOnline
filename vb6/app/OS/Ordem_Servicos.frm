...
Begin VB.Form Ordem_Servicos 
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   555
         Left            =   1680
         Picture         =   "Ordem_Servicos.frx":23D2
         Top             =   0
         Width           =   675
      End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "Ordem_Servicos.frx":2939
      ...
      TabPicture(1)   =   "Ordem_Servicos.frx":2955
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Picture1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "PEÇAS"
      TabPicture(2)   =   "Ordem_Servicos.frx":2971
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Picture2"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "PGTO"
      TabPicture(3)   =   "Ordem_Servicos.frx":298D
      ...
      TabCaption(4)   =   " "
      TabPicture(4)   =   "Ordem_Servicos.frx":29A9
      Tab(4).ControlEnabled=   0   'False
      Tab(4).ControlCount=   0
      TabCaption(5)   =   " CONSULTA"
      TabPicture(5)   =   "Ordem_Servicos.frx":29C5
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "lblQuantFiltro"
      Tab(5).Control(1)=   "lblQuant"
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin ChamaleonBtn.chameleonButton cmdPecas 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Ordem_Servicos.frx":2AA5
            PICN            =   "Ordem_Servicos.frx":2AC1
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin ChamaleonBtn.chameleonButton cmdServicos 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Ordem_Servicos.frx":3065
            PICN            =   "Ordem_Servicos.frx":3081
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdGerarEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos.frx":3569
         PICN            =   "Ordem_Servicos.frx":3585
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos.frx":389F
         PICN            =   "Ordem_Servicos.frx":38BB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdApagar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos.frx":4195
         PICN            =   "Ordem_Servicos.frx":41B1
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos.frx":44CB
         PICN            =   "Ordem_Servicos.frx":44E7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelarEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos.frx":51C1
         PICN            =   "Ordem_Servicos.frx":51DD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Ordem_Servicos"
...
Private Sub menu_Impressao_Entrada_Click()
   ...
   With REL_OS_Entrada
      ...
      REL_OS_Entrada.Preencher_Acessorios txtCodOS.Text
      REL_OS_Entrada.Preencher_Situacao txtCodOS.Text
      .Relatorio.NumeroRegistros = 1
      .Relatorio.NomeImpressora = var_Impressora
      .Relatorio.Ativar
   End With
   Unload REL_OS_Entrada
...
'sSQL = "SELECT * FROM os WHERE (cod_os = " & txtCodOS.Text & ") AND (status IS NULL);"
'Set r = dbData.OpenRecordset(sSQL)
...
'   dbData.Execute "DELETE FROM os WHERE (codigo = " & txtCodOS.Text & ");"
'End If
