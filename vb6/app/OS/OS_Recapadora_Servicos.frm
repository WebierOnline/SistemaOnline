...
Begin VB.Form OS_Recapadora_Servicos 
   ...
   ClientTop       =   330
   ClientWidth     =   9255
   Icon            =   "OS_Recapadora_Servicos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6225
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   120
         Picture         =   "OS_Recapadora_Servicos.frx":23D2
         Top             =   45
         Width           =   900
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "OS_Recapadora_Servicos.frx":28A9
      ...
      TabPicture(1)   =   "OS_Recapadora_Servicos.frx":28C5
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":28E1
         PICN            =   "OS_Recapadora_Servicos.frx":28FD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":468F
         PICN            =   "OS_Recapadora_Servicos.frx":46AB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExcluir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":643D
         PICN            =   "OS_Recapadora_Servicos.frx":6459
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSalvar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":81EB
         PICN            =   "OS_Recapadora_Servicos.frx":8207
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":9F99
         PICN            =   "OS_Recapadora_Servicos.frx":9FB5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "OS_Recapadora_Servicos.frx":BD47
         PICN            =   "OS_Recapadora_Servicos.frx":BD63
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "OS_Recapadora_Servicos"
...
Private Function Inserir_Dados() As Boolean
   ...
   'Comando de inclusão
   sSQL = "INSERT INTO os_CadServicos (codigo, tipo, servico, valor, MEDIDA, ARO, BANDA) VALUES (" & txtCodigo.Text & ", '" & cboTipo.Text & "', '" & cboServico.Text & "', " & Replace(CCur(mskValor.Text), ",", ".") & ", '" & cboMedida.Text & "', '" & txtAro.Text & "', '" & cboBanda.Text & "');"
...
sSQL = "UPDATE os_CadServicos SET servico = '" & cboServico.Text & "', valor = " & Replace(CCur(mskValor.Text), ",", ".") & ", MEDIDA = '" & cboMedida.Text & "', ARO = '" & txtAro.Text & "', BANDA = '" & cboBanda.Text & "' WHERE (codigo = " & txtCodigo.Text & ");"
...
Private Sub Auto_Numeracao()
   ...
   sSQL = "SELECT ISNULL(MAX(codigo), 0) AS cod_servico FROM os_CadServicos;"
...
sSQL = "SELECT codigo, TIPO, MEDIDA FROM OS_Pneus WHERE TIPO = '" & cboTipo.Text & "' ORDER BY MEDIDA;"
Set r = dbData.OpenRecordset(sSQL)
...
sSQL = "SELECT servico FROM os_CadServicos ORDER BY servico;"
Set r = dbData.OpenRecordset(sSQL)
...
sSQL = "DELETE FROM os_CadServicos WHERE (codigo = " & txtCodigo.Text & ");"
...
sSQL = "SELECT * FROM os_CadServicos ORDER BY servico;"
Set r = dbData.OpenRecordset(sSQL)
