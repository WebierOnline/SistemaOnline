...
Begin VB.Form NFe_Simplificada 
   BackColor       =   &H00D8E9EC&
   ...
   Begin TabDlg.SSTab Frm_NF 
      ...
      TabPicture(0)   =   "NFe_Simplificada.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "cmdConsultar"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "cmdRecalcularNF"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "cmdAlterar"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdSalvar"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "cmdCancelarNota"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "cmdTransmitir"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdImprimir"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmdExcluir"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "cmdSair"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "cmdNovo"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cmdCancelar"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "frmNota"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "frmTransmissao"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "frmItens"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).ControlCount=   14
      TabCaption(1)   =   "Consulta"
      TabPicture(1)   =   "NFe_Simplificada.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "cboTipoEmissao"
      Tab(1).Control(1)=   "cboFormatoDANFe"
      Tab(1).Control(2)=   "cboIndicadorPagamento"
      Tab(1).Control(3)=   "txtInfComple"
      Tab(1).Control(4)=   "txtCodTransporte"
      Tab(1).Control(5)=   "Text18"
      Tab(1).Control(6)=   "Text13"
      Tab(1).Control(7)=   "Text12"
      Tab(1).Control(8)=   "Text11"
      Tab(1).Control(9)=   "Text10"
      Tab(1).Control(10)=   "Text9"
      Tab(1).Control(11)=   "Text23"
      Tab(1).Control(12)=   "cboTransporte"
      Tab(1).Control(13)=   "txtValorFrete"
      Tab(1).Control(14)=   "Text1"
      Tab(1).Control(15)=   "Text22"
      Tab(1).Control(16)=   "Text21"
      Tab(1).Control(17)=   "Text19"
      Tab(1).Control(18)=   "Text16"
      Tab(1).Control(19)=   "Text15"
      Tab(1).Control(20)=   "Frame3"
      Tab(1).Control(21)=   "Text17"
      Tab(1).Control(22)=   "Command1"
      Tab(1).Control(23)=   "GridNotas"
      Tab(1).Control(24)=   "Label35"
      Tab(1).Control(25)=   "Label34"
      Tab(1).Control(26)=   "Label33"
      Tab(1).Control(27)=   "Label25"
      Tab(1).Control(28)=   "lblTotalNota"
      Tab(1).Control(29)=   "Label9"
      Tab(1).Control(30)=   "Label13"
      Tab(1).Control(31)=   "Label12"
      Tab(1).Control(32)=   "Label10"
      Tab(1).Control(33)=   "Label17"
      Tab(1).Control(34)=   "Label18"
      Tab(1).Control(35)=   "Label22"
      Tab(1).Control(36)=   "Label7"
      Tab(1).Control(37)=   "Label8"
      Tab(1).Control(38)=   "Label21"
      Tab(1).Control(39)=   "Label20"
      Tab(1).Control(40)=   "Label19"
      Tab(1).Control(41)=   "Label16"
      Tab(1).Control(42)=   "Label15"
      Tab(1).Control(43)=   "Label11"
      Tab(1).Control(44)=   "Label14"
      Tab(1).ControlCount=   45
      TabCaption(2)   =   "Pedidos"
      TabPicture(2)   =   "NFe_Simplificada.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "frmFiltrosPedidos"
      Tab(2).Control(1)=   "GridPedidos"
      Tab(2).Control(2)=   "lblQuantPedidos"
      ...
      Begin VB.TextBox txtInfComple 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   163
         Text            =   "NFe_Simplificada.frx":0054
         Top             =   5040
         Visible         =   0   'False
         Width           =   10680
      End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame4 
            ...
            Begin ChamaleonBtn.chameleonButton cmdConNotaCal2 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "NFe_Simplificada.frx":00B8
               PICN            =   "NFe_Simplificada.frx":00D4
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin ChamaleonBtn.chameleonButton cmdConNotaCal1 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "NFe_Simplificada.frx":24B6
               PICN            =   "NFe_Simplificada.frx":24D2
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdExibirConNotas 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":48B4
            PICN            =   "NFe_Simplificada.frx":48D0
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.Frame frmFiltrosPedidos 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalPedidos2 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "NFe_Simplificada.frx":51AA
               PICN            =   "NFe_Simplificada.frx":51C6
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalPedidos1 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "NFe_Simplificada.frx":75A8
               PICN            =   "NFe_Simplificada.frx":75C4
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
         ...
         Begin VB.Frame Frame1 
            ...
            End
         End
         Begin ChamaleonBtn.chameleonButton Command2 
            Height          =   495
            Left            =   9960
            TabIndex        =   84
            Top             =   360
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":99A6
            PICN            =   "NFe_Simplificada.frx":99C2
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin VB.Frame frmItens 
         ...
         Begin ChamaleonBtn.chameleonButton cmdAdicionarItem 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":A29C
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdRemoverItem 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":A2B8
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         End
      End
      Begin VB.Frame frmTransmissao 
         Caption         =   "Assinatura / Transmissão"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frmNota 
         ...
         Begin ChamaleonBtn.chameleonButton cmdCal2 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":A2D4
            PICN            =   "NFe_Simplificada.frx":A2F0
            PICH            =   "NFe_Simplificada.frx":C643
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdCal1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Simplificada.frx":E996
            PICN            =   "NFe_Simplificada.frx":E9B2
            PICH            =   "NFe_Simplificada.frx":10D05
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":13058
         PICN            =   "NFe_Simplificada.frx":13074
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":14E06
         PICN            =   "NFe_Simplificada.frx":14E22
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":16BB4
         PICN            =   "NFe_Simplificada.frx":16BD0
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExcluir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":18962
         PICN            =   "NFe_Simplificada.frx":1897E
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdImprimir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":1A710
         PICN            =   "NFe_Simplificada.frx":1A72C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdTransmitir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":1C4BE
         PICN            =   "NFe_Simplificada.frx":1C4DA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelarNota 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":1E26C
         PICN            =   "NFe_Simplificada.frx":1E288
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSalvar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":1E8C9
         PICN            =   "NFe_Simplificada.frx":1E8E5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":20677
         PICN            =   "NFe_Simplificada.frx":20693
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdRecalcularNF 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":22425
         PICN            =   "NFe_Simplificada.frx":22441
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdConsultar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Simplificada.frx":241D3
         PICN            =   "NFe_Simplificada.frx":241EF
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Label Label39 
         ...
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "NFe - Nota Fiscal Eletrônica (Simplificada)"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   750
         Left            =   540
         Picture         =   "NFe_Simplificada.frx":24AC9
         Top             =   0
         Width           =   750
      End
   End
End
Attribute VB_Name = "NFe_Simplificada"
...
'If Text15.Text = "" Then MsgBox "O campo mensagem é obrigatório.", vbCritical, "Online Commerce": Text15.SetFocus: Exit Sub
...
'On Error GoTo erro
    ...
    TbNotas("NaturezaOperacao") = Format(cboNatureza, "@")
...
'    TbNotas("HoraSaida") = Format(mskHora, "@")
    ...
    TbNotas("VolumeQuantidade") = Format(Text10, "@")
    TbNotas("VolumeEspecie") = Format(Text11, "@")
    TbNotas("VolumeMarca") = Format(Text12, "@")
    TbNotas("VolumeNumeracao") = Format(txtVolNumeracao, "@")
    TbNotas("CodigoObservacao") = IIf(IsNull(Format(Text15, "@")) Or Vazio(Format(Text15, "@")), 0, Format(Text15, "@"))
    TbNotas("ValorFrete") = IIf(Vazio(txtValorFrete), 0, CDbl(Format(txtValorFrete, "##0.00")))
    TbNotas("ValorSeguro") = IIf(IsNull(Format(Text19, "@")) Or Vazio(Format(Text19, "@")), 0, CDbl(Format(Text19, "##0.00")))
    TbNotas("ValorOutrasDespesas") = IIf(IsNull(Format(Text16, "@")) Or Vazio(Format(Text16, "@")), 0, CDbl(Format(Text16, "##0.00")))
    TbNotas("NumeroNota") = Format(txtNumNota, "@")
    TbNotas("cCodigoNota") = IIf(TbNotas("cCodigoNota") = 0, GeraCodigoNota, TbNotas("cCodigoNota"))
    TbNotas("VolumePesoBruto") = IIf(IsNull(Format(Text17, "@")) Or Vazio(Format(Text17, "@")), 0, CDbl(Format(Text17, "##0.000")))
    TbNotas("VolumePesoLiquido") = IIf(IsNull(Format(Text18, "@")) Or Vazio(Format(Text18, "@")), 0, CDbl(Format(Text18, "##0.000")))
    TbNotas("BaseICMS") = IIf(IsNull(Format(Text22, "@")) Or Vazio(Format(Text22, "@")), 0, CDbl(Format(Text22, "##0.000")))
    TbNotas("BaseICMSST") = IIf(IsNull(Format(Text21, "@")) Or Vazio(Format(Text21, "@")), 0, CDbl(Format(Text21, "##0.00")))
    TbNotas("TranspPlacaUF") = Format(Text23, "@")
...
'cboConsumidorFinal
    ...
    Text1 = Format(TbNotas("InformacoesAdicionais"), "@")
    cboNatureza = Format(TbNotas("NaturezaOperacao"), "@")
    ...
    Text9 = Format(TbNotas("TranspPlaca"), "@")
    Text10 = Format(TbNotas("VolumeQuantidade"), "@")
    Text11 = Format(TbNotas("VolumeEspecie"), "@")
    Text12 = Format(TbNotas("VolumeMarca"), "@")
    txtVolNumeracao = Format(TbNotas("VolumeNumeracao"), "@")
    Text15 = Format(TbNotas("CodigoObservacao"), "@")
    txtNumNota = Format(TbNotas("NumeroNota"), "@")
    Text19 = Format(TbNotas("ValorSeguro"), "##,##0.00")
    Text16 = Format(TbNotas("ValorOutrasDespesas"), "##,##0.00")
    txtValorFrete = Format(TbNotas("ValorFrete"), "##,##0.00")
    Text22 = Format(TbNotas("BaseICMS"), "##,##0.00")
    Text21 = Format(TbNotas("BaseICMSST"), "##,##0.00")
    Text17 = Format(TbNotas("VolumePesoBruto"), "@")
    Text18 = Format(TbNotas("VolumePesoLiquido"), "@")
    Text23 = Format(TbNotas("TranspPlacaUF"), "@")
...
Dim VarText As String
VarText = cboNatureza.Text

cboNatureza.Clear
cboNatureza.AddItem "VENDA DE MERCADORIA"
cboNatureza.AddItem ""

If cboNatureza.Text = "" Then cboNatureza.Text = VarText
...
Private Sub cmdImprimir_Click()
   On Error GoTo deuErro
     ...
     Call sistNFe.DANFeImprimir(xCaminhoXML, False, "", True, xCaminhoPDF, 0, False, False, "")
     
     Exit Sub
deuErro:
    If InStr(1, Err.Description, "Exception") > 0 Then
       iRetorno = ConfiguraDLLNFeNFCe(55, "1", sistNFe)
       Call sistNFe.DANFeImprimir(xCaminhoXML, False, "", True, xCaminhoPDF, 1, False, False, "")
    Else
...
'    txtCodNota = Format(rTabela("CodigoNota"), "@")
    ...
    cboDestOperacao.Text = "1 - Operação Interna"
    'Text1 = Format(rTabela("InformacoesAdicionais"), "@")
    ...
    Text19 = Format(0, "##,##0.00")
    Text16 = Format(0, "##,##0.00")
    txtValorFrete = Format(0, "##,##0.00")
    Text22 = Format(0, "##,##0.00")
    Text21 = Format(0, "##,##0.00")
    Text17 = Format(0, "@")
    Text18 = Format(0, "@")
    Text23 = Format(0, "@")
...
If KeyCode = 13 Then
    If Text15.Text = "" Then
        ...
        Exit Sub
    End If
    RsOpen TbMSN, "select * from ObservacoesNFe where CodigoObservacao = " & Val(Text15.Text)
    ...
    Else
        Text15.Text = TbMSN("CodigoObservacao")
    End If
End If
Exit Sub
erro:
