...
Begin VB.Form Vendas_Consulta_Geral 
   ...
   ClientTop       =   330
   ClientWidth     =   10005
   Icon            =   "Vendas_Consulta_Geral.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   10995
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirPedidos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Vendas_Consulta_Geral.frx":23D2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.Frame frmFiltro1 
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalendario1 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "Vendas_Consulta_Geral.frx":23EE
               PICN            =   "Vendas_Consulta_Geral.frx":240A
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalendario2 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "Vendas_Consulta_Geral.frx":47EC
               PICN            =   "Vendas_Consulta_Geral.frx":4808
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdLocalizar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Vendas_Consulta_Geral.frx":6BEA
         PICN            =   "Vendas_Consulta_Geral.frx":6C06
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Vendas_Consulta_Geral.frx":74E0
         PICN            =   "Vendas_Consulta_Geral.frx":74FC
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdImprimir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Vendas_Consulta_Geral.frx":7816
         PICN            =   "Vendas_Consulta_Geral.frx":7832
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox picAguarde 
      ...
      Height          =   1095
      Left            =   3600
      Picture         =   "Vendas_Consulta_Geral.frx":7B4C
      ScaleHeight     =   1095
      ScaleWidth      =   2895
      TabIndex        =   12
      Top             =   6660
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   825
         Left            =   240
         Picture         =   "Vendas_Consulta_Geral.frx":8B84
         Top             =   0
         Width           =   1140
      End
   End
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirProdutos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Vendas_Consulta_Geral.frx":F3CA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirParcelas 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Vendas_Consulta_Geral.frx":F3E6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Vendas_Consulta_Geral"
...
Private Sub cboIndice_GotFocus()
   ...
   If cboTipo.Text = "PEDIDOS" Or cboTipo.Text = "ORÇAMENTOS" Or cboTipo.Text = "OFICINA" Then
      ...
      cboIndice.AddItem "No. PEDIDO"
   ElseIf cboTipo.Text = "POR PRODUTOS" Or cboTipo.Text = "PRODUTOS COM LUCRO" Then
...
ElseIf cboIndice.Text = "VALOR" Then
   INDICE = "pedidos.total;"
ElseIf cboIndice.Text = "No. PEDIDO" Then
   INDICE = "pedidos.cod_pedido;"
Else
   INDICE = "data_compra, nome"
End If
...
'If CboFormaPgtoSec.Text = "COM ENTRADA" Then
'   varFormaPagto = "(pedidos.tipo_pagamento = 'à prazo') AND (pedidos.data_compra = parcelas.pagamento) AND (parcelas.numero = 1) AND "
'ElseIf CboFormaPgtoSec.Text = "SEM ENTRADA" Then
'   varFormaPagto = "(pedidos.data_compra <> parcelas.pagamento) AND"
'Else
'   varFormaPagto = ""
'End If
...
If cboCriterioPrinc.Text = "" Then Exit Sub
   ...
   If cboCriterioPrinc.Text = "VENDEDOR" And cboCriterioSec.Text = "TODOS" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(pedidos.cod_funcionario = " & txtCodFunc.Text & ") AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & _
         Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   ...
   ElseIf cboCriterioPrinc.Text = "VENDEDOR" And cboCriterioSec.Text = "MENSAL" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(pedidos.cod_funcionario = " & txtCodFunc.Text & ") AND (MONTH(pedidos.data_compra) = " & cboMes.ListIndex + 1 & ") " & _
         "AND (YEAR(pedidos.data_compra) = " & cboAno & ") AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & _
         Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
         
   'VENDEDOR - CATEGORIA
   ElseIf cboCriterioPrinc.Text = "VENDEDOR" And cboCriterioSec.Text = "CATEGORIA" Then
      If cboVendedor.Text = "" Then Limpar_Grid_Venda: Exit Sub
      If cboCategoria.Text = "" Then Limpar_Grid_Venda: Exit Sub
      
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "INNER JOIN pedidos_itens ON pedidos_itens.cod_pedido = pedidos.cod_pedido " & _
         "WHERE " & varFormaPagto & _
         "(pedidos_itens.cod_produto IN (SELECT codigo FROM produtos WHERE (categoria = '" & cboCategoria.Text & "'))) AND (pedidos.cod_funcionario = " & txtCodFunc.Text & ") " & _
         "AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   
   'VENDEDOR - MENSAL/CATEGORIA
   ElseIf cboCriterioPrinc.Text = "VENDEDOR" And cboCriterioSec.Text = "MENSAL + CAT." Then
      If cboVendedor.Text = "" Then Limpar_Grid_Venda: Exit Sub
      If cboCategoria.Text = "" Then Limpar_Grid_Venda: Exit Sub
      If cboMes.Text = "" Or cboAno.Text = "" Then Limpar_Grid_Venda: Exit Sub
      
'         sSQL = "SELECT DISTINCT cliente.*, pedidos.*, pedidos.cod_pedido AS var_codped, pedidos.total AS var_total " & _
...
'            "INNER JOIN parcelas ON parcelas.cod_pedido = pedidos.cod_pedido  " & _
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "INNER JOIN pedidos_itens ON pedidos.cod_pedido = pedidos_itens.cod_pedido " & _
         "WHERE " & varFormaPagto & _
         "(pedidos_itens.cod_produto IN (SELECT codigo FROM produtos WHERE (categoria = '" & cboCategoria.Text & "'))) AND (pedidos.cod_funcionario = " & txtCodFunc.Text & ") " & _
   ...
   ElseIf cboCriterioPrinc.Text = "CLIENTE" And cboCriterioSec.Text = "TODOS" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(cliente.codigo = " & TxtCodCliente.Text & ") AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & _
         Tipo & tipo_Cartao & var_TipoPgto & " cancelado = '0' ORDER BY " & INDICE
   ...
   ElseIf cboCriterioPrinc.Text = "CLIENTE" And cboCriterioSec.Text = "MENSAL" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(cliente.codigo = " & TxtCodCliente.Text & ") AND (MONTH(pedidos.data_compra) = " & cboMes.ListIndex + 1 & ") " & _
         "AND (YEAR(pedidos.data_compra) = " & cboAno & ") AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   ...
   ElseIf cboCriterioPrinc.Text = "PERIODO" And cboCriterioSec.Text = "" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(pedidos.data_compra >= CONVERT(DATETIME, '" & Format(mskInicio.Text, ocDATA) & "', 103)) AND (pedidos.data_compra <= CONVERT(DATETIME, '" & Format(mskFim.Text, ocDATA) & "', 103)) " & _
         "AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   
   'INNER JOIN parcelas ON parcelas.cod_pedido = pedidos.cod_pedido (no final do primeiro inner)
   ', parcelas.valor_final (no inicio)
   ...
   ElseIf cboCriterioPrinc.Text = "CÓDIGO" And cboCriterioSec.Text = "" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(pedidos.cod_pedido = " & txtCodigo.Text & ") AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   ...
   ElseIf cboCriterioPrinc.Text = "MENSAL" And cboCriterioSec.Text = "" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(MONTH(pedidos.data_compra) = " & cboMes.ListIndex + 1 & ") AND (YEAR(pedidos.data_compra) = " & cboAno & ") " & _
         "AND (pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = '0' ORDER BY " & INDICE
   ...
   ElseIf cboCriterioPrinc.Text = "TODOS" And cboCriterioSec.Text = "" Then
      ...
      sSQL = "SELECT DISTINCT (pedidos.COD_PEDIDO) as var_codped, pedidos.data_compra, pedidos.tipo_pagamento, pedidos.pagamento, pedidos.tipo_pedido, pedidos.COD_CLIENTE, pedidos.total AS var_total, cliente.nome, cliente.CODIGO " & _
         "FROM pedidos INNER JOIN cliente ON pedidos.COD_CLIENTE = cliente.CODIGO  " & _
         "WHERE " & varFormaPagto & _
         "(pedidos.tipo_pedido = '" & varTipoConsulta & "') " & Tipo & tipo_Cartao & var_TipoPgto & " and cancelado = 0 ORDER BY " & INDICE
   End If
...
If CboFormaPgtoSec.Text = "COM ENTRADA" Then
   FormatarGrid_VendasComEntrada r
Else
