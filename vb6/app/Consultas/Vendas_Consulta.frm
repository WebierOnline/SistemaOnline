...
Begin VB.Form Vendas_Consulta 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.Frame frmFiltro1 
         ...
         Begin ChamaleonBtn.chameleonButton cmdCalendario2 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Vendas_Consulta.frx":23D2
            PICN            =   "Vendas_Consulta.frx":23EE
            PICH            =   "Vendas_Consulta.frx":4741
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdCalendario1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Vendas_Consulta.frx":6A94
            PICN            =   "Vendas_Consulta.frx":6AB0
            PICH            =   "Vendas_Consulta.frx":8E03
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdCal1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Vendas_Consulta.frx":B156
            PICN            =   "Vendas_Consulta.frx":B172
            PICH            =   "Vendas_Consulta.frx":D4C5
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdLocalizar 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Vendas_Consulta.frx":F818
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdImprimir 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Vendas_Consulta.frx":F834
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   Begin VB.PictureBox picAguarde 
      ...
      Height          =   1095
      Left            =   4740
      Picture         =   "Vendas_Consulta.frx":F850
      ScaleHeight     =   1095
      ScaleWidth      =   2895
      TabIndex        =   3
      Top             =   5820
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   585
         Left            =   240
         Picture         =   "Vendas_Consulta.frx":10888
         Stretch         =   -1  'True
         Top             =   0
         Width           =   900
      End
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirProdutos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Vendas_Consulta.frx":170CE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirParcelas 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Vendas_Consulta.frx":170EA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Vendas_Consulta"
...
Private Sub PreencherTipoVendas()
cboTipoVenda.Clear
cboTipoVenda.AddItem "TODOS"
cboTipoVenda.AddItem "VENDAS"
cboTipoVenda.AddItem "OFICINA"
End Sub
...
If cboCriterioSec.Text = "MENSAL" Then
   ...
   lblData.Visible = False
    ...
    cboMes.Top = 1020
    cboAno.Top = 1020
    cmdLocalizar.Top = 1440
    cmdImprimir.Top = 1440
End If
...
Private Sub cboTipoVenda_GotFocus()
moCombo.AttachTo cboTipoVenda
End Sub
...
If IsNumeric(Grid.TextMatrix(Grid.Row, 1)) = True Then
   If Grid.Col = 1 Then
      ...
      Parcelas_Consulta_Produtos.loadPedidos Grid.TextMatrix(Grid.Row, 1), Grid.TextMatrix(Grid.Row, 9)
...
If cboTipoVenda.Text = "VENDAS" Then
   varTipoConsulta = " = 'VENDA'"
ElseIf cboTipoVenda.Text = "OFICINA" Then
   varTipoConsulta = " = 'OFICINA'"
ElseIf cboTipoVenda.Text = "TODOS" Then
   ...
   With Grid
      ...
      If Not rTabela Is Nothing Then
         Do While Not rTabela.EOF
            ...
            .TextMatrix(.rows - 1, 9) = rTabela("TIPO_PEDIDO")
...
'            .TextMatrix(.rows - 1, 10) = ValidateNull(rTabela("vTipoPgto"))
   ...
   End With
    ...
    lblSubtotal = Format(SomaGrid(Grid, 4), ocMONEY)
    lblTotalDesc = Format(SomaGrid(Grid, 5), ocMONEY)
    lblTotalAcresc = Format(SomaGrid(Grid, 6), ocMONEY)
    lblSubtotalBruto = Format(SomaGrid(Grid, 7), ocMONEY)
