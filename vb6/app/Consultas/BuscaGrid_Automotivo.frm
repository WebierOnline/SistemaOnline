...
Begin VB.Form BuscaGrid_Automotivo 
   ...
   End
End
Attribute VB_Name = "BuscaGrid_Automotivo"
...
Sub pCriarGrid()
   ...
   lstBusca.ColumnHeaders.Add , , "DESCRIÇÃO", 3500
   lstBusca.ColumnHeaders.Add , , "COMPARTIBILIDADE", 4700
   lstBusca.ColumnHeaders.Add , , "QUANT", 800, 1
...
Private Sub lstBusca_KeyDown(KeyCode As Integer, Shift As Integer)
   If Shift = 0 And KeyCode = vbKeyReturn Then
      ...
      vInfo(5) = lstBusca.SelectedItem.ListSubItems.Item(5).Text
      mCancelled = False
      Unload Me
   End If
