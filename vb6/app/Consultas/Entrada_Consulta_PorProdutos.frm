...
Begin VB.Form Entrada_Consulta_PorProdutos 
   ...
   ClientTop       =   330
   ClientWidth     =   11535
   Icon            =   "Entrada_Consulta_PorProdutos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9780
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirPedidos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Entrada_Consulta_PorProdutos.frx":23D2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin ChamaleonBtn.chameleonButton cmdCalendario2 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Entrada_Consulta_PorProdutos.frx":23EE
            PICN            =   "Entrada_Consulta_PorProdutos.frx":240A
            PICH            =   "Entrada_Consulta_PorProdutos.frx":475D
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdCalendario1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Entrada_Consulta_PorProdutos.frx":6AB0
            PICN            =   "Entrada_Consulta_PorProdutos.frx":6ACC
            PICH            =   "Entrada_Consulta_PorProdutos.frx":8E1F
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdLocalizar 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Entrada_Consulta_PorProdutos.frx":B172
            PICN            =   "Entrada_Consulta_PorProdutos.frx":B18E
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
         ...
         Begin ChamaleonBtn.chameleonButton cmdImprimir 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "Entrada_Consulta_PorProdutos.frx":BA68
            PICN            =   "Entrada_Consulta_PorProdutos.frx":BA84
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
   ...
   Begin VB.PictureBox picAguarde 
      ...
      Height          =   1095
      Left            =   3960
      Picture         =   "Entrada_Consulta_PorProdutos.frx":BD9E
      ScaleHeight     =   1095
      ScaleWidth      =   2895
      TabIndex        =   14
      Top             =   5160
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Label Label33 
         ...
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "CONSULTA DE ENTRADA POR PRODUTOS"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   825
         Left            =   240
         Picture         =   "Entrada_Consulta_PorProdutos.frx":CDD6
         Top             =   0
         Width           =   1140
      End
   End
   ...
   End
End
Attribute VB_Name = "Entrada_Consulta_PorProdutos"
...
SelectControl cboCriterioPrinc
...
With Grid
   ...
   .ColAlignment(3) = 5
    ...
    .TextMatrix(0, 1) = "USUÁRIO"
    .TextMatrix(0, 2) = "COD"
    .TextMatrix(0, 3) = "DATA"
    .TextMatrix(0, 4) = "HORA"
    .TextMatrix(0, 5) = "ENTRADA"
    .TextMatrix(0, 6) = "PRODUTO"
    .TextMatrix(0, 7) = "FORMA"
    .TextMatrix(0, 8) = "NOTA FISCAL"
    .TextMatrix(0, 9) = "QUANT"
   ...
   If Not rTabela Is Nothing Then
      Do While Not rTabela.EOF
        .TextMatrix(.rows - 1, 1) = ValidateNull(rTabela("vUsuario"))
        .TextMatrix(.rows - 1, 2) = ValidateNull(rTabela("Codigo"))
        .TextMatrix(.rows - 1, 3) = Format$(rTabela("Data"), "dd/mm/yy")
        .TextMatrix(.rows - 1, 4) = Format$(rTabela("HORA"), ocHORA)
...
lblQtdaTotal.Caption = SomaGrid(Grid, 9)
End With
End Sub
