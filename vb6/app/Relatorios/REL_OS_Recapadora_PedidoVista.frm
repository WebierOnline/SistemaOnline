...
Begin VB.Form REL_OS_Recapadora_PedidoVista 
   ClientHeight    =   8685
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13170
   ...
   End
End
Attribute VB_Name = "REL_OS_Recapadora_PedidoVista"
...
Public Sub loadPedidos(ByVal Pedido As Long, ByVal Tipo As String)
   ...
   If UCase(Tipo) = "OFICINA" Then
      sSQL = sSQL & " UNION "
      sSQL = sSQL & "SELECT 'SERVIÇO' AS tipo_item, descricao, quantidade, preco, ISNULL((quantidade * preco), 0) AS total, codigo, TIPO as varTipo, SERIE as varSerie, FOGO as varFogo, FABRICANTE as varFabricante, MEDIDA as varMedida, ARO as varAro, BANDA as varBanda " & _
