...
Begin VB.Form REL_Aluguel_Listadecontratos 
   ...
   ClientTop       =   330
   ClientWidth     =   12570
   Icon            =   "REL_Aluguel_Listadecontratos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   60.854
   ...
   End
End
Attribute VB_Name = "REL_Aluguel_Listadecontratos"
