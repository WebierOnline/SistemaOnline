...
Begin VB.Form REL_Garantia2 
   ...
   End
End
Attribute VB_Name = "REL_Garantia2"
...
Private Sub rfCodCliente_Change()
   ...
   txtRef.Caption = r("ponto_de_referencia")
   txtTel.Caption = r("telefone1")
   txtCidade.Caption = r("cidade")
   txtEstado.Caption = r("estado")
   txtCPF.Caption = r("cpf")
   txtRG.Caption = r("ci")
   txtBairro.Caption = r("bairro")
