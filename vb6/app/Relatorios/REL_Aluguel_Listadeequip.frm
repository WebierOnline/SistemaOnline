...
Begin VB.Form REL_Aluguel_Listadeequip 
   ...
   ClientTop       =   330
   ClientWidth     =   12570
   Icon            =   "REL_Aluguel_Listadeequip.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   60.854
   ...
   Begin ReportX.ReportSection ReportSection2 
      ...
      Begin ReportX.ReportField dfDesc 
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfModelo 
         Height          =   195
         Left            =   4440
         TabIndex        =   7
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfFab 
         Height          =   195
         Left            =   5940
         TabIndex        =   8
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfQuantE 
         Height          =   195
         Left            =   9780
         TabIndex        =   9
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfValorDia 
         Height          =   195
         Left            =   7680
         TabIndex        =   16
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfValorHora 
         Height          =   195
         Left            =   8700
         TabIndex        =   17
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfQuantA 
         Height          =   195
         Left            =   10380
         TabIndex        =   20
         Top             =   0
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfQuantD 
         Height          =   195
         Left            =   10980
         TabIndex        =   21
         Top             =   0
   ...
   End
End
Attribute VB_Name = "REL_Aluguel_Listadeequip"
