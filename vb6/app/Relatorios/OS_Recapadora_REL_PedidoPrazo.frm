...
Begin VB.Form OS_Recapadora_REL_PedidoPrazo 
   ClientHeight    =   8685
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13170
   ...
   End
End
Attribute VB_Name = "OS_Recapadora_REL_PedidoPrazo"
...
Public Sub loadPedidos(ByVal Pedido As Long, ByVal Tipo As String)
   ...
   If UCase(Tipo) = "OFICINA" Then
      sSQL = sSQL & " UNION "
      sSQL = sSQL & "SELECT 'SERVIÇO' AS tipo_item, descricao, quantidade, preco, (quantidade * preco) AS total, codigo, TIPO as varTipo, SERIE as varSerie, FOGO as varFogo, FABRICANTE as varFabricante, MEDIDA as varMedida, ARO as varAro, BANDA as varBanda " & _
   ...
   txtNumero.Caption = "Nº " & Format(OS_Recapadora.txtCodOS.Text, "000000")
   ...
   frNome.Caption = rCl("nome") & " - CPF: " & rCl("cpf")
