...
Begin VB.Form REL_ReciboSangria 
   ...
   ClientTop       =   330
   ClientWidth     =   12075
   Icon            =   "REL_ReciboSangria.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   110.861
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      End
      Begin ReportX.ReportField txtSubDescricao 
         Height          =   480
         Left            =   2160
         TabIndex        =   22
         Top             =   2640
      ...
      Begin ReportX.ReportField txtDescricao 
         ...
         AlinhamentoVertical=   1
      End
      Begin ReportX.ReportField txtFonte 
         Height          =   480
         Left            =   1140
         TabIndex        =   6
         Top             =   3600
   ...
   End
End
Attribute VB_Name = "REL_ReciboSangria"
