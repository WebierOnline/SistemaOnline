...
Begin VB.Form REL_OS_Entrada_Motores 
   ...
   ClientTop       =   330
   ClientWidth     =   12075
   Icon            =   "REL_OS_Entrada_Motores.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   162.19
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      _ExtentY        =   14314
      Ordem           =   1
      Begin ReportX.ReportField txtTensao 
         Height          =   420
         Left            =   180
         TabIndex        =   42
         Top             =   4080
      ...
      End
      Begin ReportX.ReportField txtPotencia 
         Height          =   420
         Left            =   4860
         TabIndex        =   43
         Top             =   4080
      ...
      End
      Begin ReportX.ReportField txtRPM 
         Height          =   420
         Left            =   2820
         TabIndex        =   45
         Top             =   4080
      ...
      Begin ReportX.ReportField ReportField8 
         ...
         _ExtentY        =   318
         Formato         =   "##,##0.00"
         Caption         =   $"REL_OS_Entrada_Motores.frx":030A
         WordWrap        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Serif"
            Size            =   6.75
      ...
      Begin ReportX.ReportField ReportField6 
         ...
         _ExtentY        =   318
         Formato         =   "##,##0.00"
         Caption         =   $"REL_OS_Entrada_Motores.frx":03B0
         WordWrap        =   -1  'True
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Serif"
            Size            =   6.75
   ...
   End
End
Attribute VB_Name = "REL_OS_Entrada_Motores"
...
Public Sub Preencher_Situacao(Pedido As Long)
   ...
   i = 0
   Do While Not r.EOF
      If i < 10 Then lblSituacao(i).Caption = r("situacao")
      i = i + 1
      r.MoveNext
   Loop
...
Public Sub Preencher_Acessorios(Pedido As Long)
   ...
   sSQL = "SELECT acessorio, cod_os FROM os_acessorios WHERE (cod_os = " & Pedido & ");"
   Set r = dbData.OpenRecordset(sSQL)
   ...
   i = 0
   Do While Not r.EOF
      If i < 10 Then lblAcessorio(i).Caption = r("acessorio")
      i = i + 1
      r.MoveNext
   Loop
