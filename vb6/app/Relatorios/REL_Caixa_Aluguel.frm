...
Begin VB.Form REL_Caixa_Aluguel 
   ...
   ClientTop       =   330
   ClientWidth     =   12570
   Icon            =   "REL_Caixa_Aluguel.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   75.142
   ...
   Begin ReportX.ReportSection ReportSection3 
      ...
      Begin ReportX.ReportField rfSubTotal 
         ...
         Borda           =   15
      End
      Begin ReportX.ReportField rfEntrada 
         Height          =   270
         Left            =   9465
         TabIndex        =   26
         Top             =   660
   ...
   End
End
Attribute VB_Name = "REL_Caixa_Aluguel"
