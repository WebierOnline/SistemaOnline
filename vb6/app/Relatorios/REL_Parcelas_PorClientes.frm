...
Begin VB.Form REL_Parcelas_PorClientes 
   ...
   Begin ReportX.ReportSection ReportSection4 
      ...
      Begin ReportX.ReportField rf4 
         ...
         AlinhamentoVertical=   1
      End
      Begin ReportX.ReportField rfNome 
         Height          =   240
         Left            =   120
         TabIndex        =   42
         Top             =   2220
      ...
      Begin ReportX.ReportField ReportField17 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfCelular 
         Height          =   240
         Left            =   7140
         TabIndex        =   44
         Top             =   2220
      ...
      Begin ReportX.ReportField ReportField19 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfEndereco 
         Height          =   240
         Left            =   120
         TabIndex        =   46
         Top             =   2760
      ...
      Begin ReportX.ReportField ReportField21 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfNum 
         Height          =   240
         Left            =   5940
         TabIndex        =   48
         Top             =   2760
      ...
      Begin ReportX.ReportField ReportField23 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfBairro 
         Height          =   240
         Left            =   6780
         TabIndex        =   50
         Top             =   2760
      ...
      Begin ReportX.ReportField ReportField25 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfReferencia 
         Height          =   240
         Left            =   120
         TabIndex        =   52
         Top             =   3300
      ...
      Begin ReportX.ReportField ReportField27 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfCidade 
         Height          =   240
         Left            =   8880
         TabIndex        =   54
         Top             =   2760
      ...
      Begin ReportX.ReportField ReportField29 
         ...
         EndProperty
      End
      Begin ReportX.ReportField rfUF 
         Height          =   240
         Left            =   10980
         TabIndex        =   56
         Top             =   2760
      ...
      Begin VB.Label lblTitulo 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "RELATÓRIO DE PARCELA(S) UNIFICADO"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   14.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "REL_Parcelas_PorClientes"
...
Set r = Nothing
rfDataImpressao.Caption = "Data da Impressão: " & Format(Date, "dd/mm/yy") & " ás " & Format(Now, "hh:mm:ss") & "hs"
Exit Sub
