...
Begin VB.Form NFe_Completa 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabPicture(3)   =   "NFe_Completa.frx":0054
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "NFe_Completa.frx":0070
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "frmItens"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Transporte"
      TabPicture(1)   =   "NFe_Completa.frx":008C
      Tab(1).ControlEnabled=   0   'False
      ...
      Begin VB.Frame Frame3 
         ...
         Begin ChamaleonBtn.chameleonButton chameleonButton1 
            ...
            MCOL            =   12632256
            MPTR            =   1
            MICON           =   "NFe_Completa.frx":0134
            PICN            =   "NFe_Completa.frx":0150
            PICH            =   "NFe_Completa.frx":24A3
            UMCOL           =   -1  'True
            SOFT            =   0   'False
            PICPOS          =   0
            NGREY           =   0   'False
      ...
      Begin TabDlg.SSTab SSTab4 
         ...
         TabPicture(0)   =   "NFe_Completa.frx":47F6
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "txtInfComple"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Informações Adicionais"
         TabPicture(1)   =   "NFe_Completa.frx":4812
         Tab(1).ControlEnabled=   0   'False
      ...
      Begin TabDlg.SSTab SSTab3 
         ...
         TabPicture(0)   =   "NFe_Completa.frx":4892
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "Label7"
         Tab(0).Control(1)=   "txtCodTransporte"
         Tab(0).Control(2)=   "cboTransporte"
         Tab(0).Control(3)=   "Frame6"
         Tab(0).ControlCount=   4
         TabCaption(1)   =   "Volumes"
         TabPicture(1)   =   "NFe_Completa.frx":48AE
         ...
         TabPicture(2)   =   "NFe_Completa.frx":48CA
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "Frame1"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Retenção do ICMS"
         TabPicture(3)   =   "NFe_Completa.frx":48E6
         Tab(3).ControlEnabled=   0   'False
         Tab(3).ControlCount=   0
   ...
   Begin VB.Frame frmNota 
      ...
      Begin VB.ComboBox cboFinalidade 
         Height          =   315
         ItemData        =   "NFe_Completa.frx":493A
         Left            =   2400
         List            =   "NFe_Completa.frx":493C
         TabIndex        =   3
         Top             =   540
         Width           =   1995
      End
      ...
      Begin ChamaleonBtn.chameleonButton cmdCal2 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Completa.frx":493E
         PICN            =   "NFe_Completa.frx":495A
         PICH            =   "NFe_Completa.frx":6CAD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdCal1 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "NFe_Completa.frx":9000
         PICN            =   "NFe_Completa.frx":901C
         PICH            =   "NFe_Completa.frx":B36F
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":DFCD
      PICN            =   "NFe_Completa.frx":DFE9
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":FD7B
      PICN            =   "NFe_Completa.frx":FD97
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":11B29
      PICN            =   "NFe_Completa.frx":11B45
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":138D7
      PICN            =   "NFe_Completa.frx":138F3
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":15685
      PICN            =   "NFe_Completa.frx":156A1
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdSair 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":17433
      PICN            =   "NFe_Completa.frx":1744F
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdImprimir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":191E1
      PICN            =   "NFe_Completa.frx":191FD
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdTransmitir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":1AF8F
      PICN            =   "NFe_Completa.frx":1AFAB
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdCancelarNota 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":1CD3D
      PICN            =   "NFe_Completa.frx":1CD59
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdRecalcularNF 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":1D39A
      PICN            =   "NFe_Completa.frx":1D3B6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdConsultar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "NFe_Completa.frx":1F148
      PICN            =   "NFe_Completa.frx":1F164
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
