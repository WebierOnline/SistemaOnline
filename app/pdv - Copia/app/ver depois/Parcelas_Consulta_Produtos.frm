...
Begin VB.Form Parcelas_Consulta_Produtos 
   ...
   Begin ChamaleonBtn.chameleonButton cmdFechar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Parcelas_Consulta_Produtos.frx":8C18
      PICN            =   "Parcelas_Consulta_Produtos.frx":8C34
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Public Sub loadPedidos(ByVal Pedido As Long, ByVal Tipo As String)
   ...
   sSQL = "SELECT 'PRODUTO' AS tipo_item, produtos.descricao as var_desc, quantidade, preco, ISNULL((quantidade * preco), 0) AS total, produtos.codigo " & _
   ...
   If UCase(Tipo) = "OFICINA" Then
      sSQL = sSQL & " UNION "
      sSQL = sSQL & "SELECT 'SERVIÇO' AS tipo_item, descricao as var_desc, quantidade, preco, ISNULL((quantidade * preco), 0) AS total, codigo " & _
             "FROM os_servicos WHERE (cod_os = " & Pedido & ")"
   End If
   Debug.Print sSQL
   ...
   With Grid
      ...
      If Not rTabela Is Nothing Then
         Do While Not rTabela.EOF
            ...
            .TextMatrix(.Rows - 1, 2) = rTabela("var_desc")
