...
Begin VB.Form OS_Cadastro_Servicos 
   ...
   ClientTop       =   330
   ClientWidth     =   8145
   Icon            =   "Ordem_Servicos_Cadastro.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6225
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   120
         Picture         =   "Ordem_Servicos_Cadastro.frx":23D2
         Top             =   45
         Width           =   900
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "Ordem_Servicos_Cadastro.frx":28A9
      ...
      TabPicture(1)   =   "Ordem_Servicos_Cadastro.frx":28C5
      ...
      Begin ChamaleonBtn.chameleonButton cmdCancelar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":28E1
         PICN            =   "Ordem_Servicos_Cadastro.frx":28FD
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdAlterar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":468F
         PICN            =   "Ordem_Servicos_Cadastro.frx":46AB
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdExcluir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":643D
         PICN            =   "Ordem_Servicos_Cadastro.frx":6459
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSalvar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":81EB
         PICN            =   "Ordem_Servicos_Cadastro.frx":8207
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdNovo 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":9F99
         PICN            =   "Ordem_Servicos_Cadastro.frx":9FB5
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Ordem_Servicos_Cadastro.frx":BD47
         PICN            =   "Ordem_Servicos_Cadastro.frx":BD63
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "OS_Cadastro_Servicos"
   ...
   With Grid
      ...
      If Not rTabela Is Nothing Then
         Do While Not rTabela.EOF
            ...
            .TextMatrix(.Rows - 1, 2) = rTabela("servico")
...
cboServico.Text = (Grid.TextMatrix(Grid.Row, 2))
mskValor.Text = (Grid.TextMatrix(Grid.Row, 3))
...
mskValor.Text = Format(mskValor.Text, ocMONEY)
End Sub
