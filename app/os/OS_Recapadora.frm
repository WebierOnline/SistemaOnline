...
Begin VB.Form OS_Recapadora 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(5)=   "cmdPedidoPDF"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdOrcamentoPDF"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmdImpGarantia1"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "cmdImpPedido1"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "cmdImpOrcamento1"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "cmdImpEntrada1"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "cmdFinanceiroOS"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "cmdNovoOS"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "cmdEditarOS"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "GridPecasServicos"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "Grid_OS"
