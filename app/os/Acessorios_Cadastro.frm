...
Begin VB.Form Acessorios_Cadastro 
   ...
   ClientTop       =   330
   ClientWidth     =   6105
   Icon            =   "Acessorios_Cadastro.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5280
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   120
         Picture         =   "Acessorios_Cadastro.frx":23D2
         Top             =   45
         Width           =   675
      End
   End
   ...
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acessorios_Cadastro.frx":2BAD
      PICN            =   "Acessorios_Cadastro.frx":2BC9
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acessorios_Cadastro.frx":3D13
      PICN            =   "Acessorios_Cadastro.frx":3D2F
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acessorios_Cadastro.frx":4609
      PICN            =   "Acessorios_Cadastro.frx":4625
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Acessorios_Cadastro.frx":493F
      PICN            =   "Acessorios_Cadastro.frx":495B
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Acessorios_Cadastro"
...
Private Function Inserir_Dados() As Boolean
   ...
   'Comando de inclusão
   sSQL = "INSERT INTO acessorios (codigo, acessorio) VALUES (" & txtCodigo.Text & ", '" & cboSetor.Text & "');"
...
Private Function Atualizar_Dados() As Boolean
   ...
   sSQL = "UPDATE acessorios SET acessorio = '" & cboSetor.Text & "' WHERE (codigo = " & txtCodigo.Text & ");"
...
Private Sub Auto_Numeracao()
   ...
   sSQL = "SELECT ISNULL(MAX(codigo), 0) AS cod FROM acessorios;"
...
sSQL = "SELECT * FROM acessorios ORDER BY acessorio;"
Set r = dbData.OpenRecordset(sSQL)
...
Private Sub cmdAlterar_Click()
   ...
   'sSQL = "SELECT * FROM acessorios WHERE (codigo = " & txtCodigo.Text & ");"
   'Set r = dbData.OpenRecordset(sSQL)
...
Private Sub cmdExcluir_Click()
   ...
   sSQL = "DELETE FROM acessorios WHERE (codigo = " & txtCodigo.Text & ");"
