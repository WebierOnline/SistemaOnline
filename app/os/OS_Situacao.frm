...
Private Function Inserir_Dados() As Boolean
   ...
   'Comando de inclusão
   sSQL = "INSERT INTO OS_Situacao (codigo, situacao) VALUES (" & txtCodigo.Text & ", '" & cboSetor.Text & "');"
...
Private Function Atualizar_Dados() As Boolean
   ...
   sSQL = "UPDATE OS_Situacao SET situacao = '" & cboSetor.Text & "' WHERE (codigo = " & txtCodigo.Text & ");"
...
Private Sub Auto_Numeracao()
   ...
   sSQL = "SELECT ISNULL(MAX(codigo), 0) AS cod FROM OS_Situacao;"
...
Private Sub Exibir_Situacao()
Dim sSQL As String
Dim r As ADODB.Recordset

sSQL = "SELECT * FROM OS_Situacao ORDER BY situacao;"
Set r = dbData.OpenRecordset(sSQL)
   ...
   With Grid
      ...
      If Not rTabela Is Nothing Then
         Do While Not rTabela.EOF
            ...
            .TextMatrix(.Rows - 1, 2) = rTabela("situacao")
...
If ShowMsg("Excluir esse SITUAÇÃO?", vbInformation + vbYesNo + vbDefaultButton2) = vbNo Then Exit Sub

'Faz a exclusão usando o comando DELETE do SQL
sSQL = "DELETE FROM OS_Situacao WHERE (codigo = " & txtCodigo.Text & ");"
