...
Begin VB.Form REL_Pedido_Mod05 
   ...
   Begin ReportX.ReportSection ReportSection2 
      ...
      Begin VB.Image Image1 
         Height          =   630
         Left            =   8760
         Picture         =   "REL_Pedido_Mod05.frx":0000
         Stretch         =   -1  'True
         Top             =   7200
         Width           =   2655
      End
...
Public Sub loadPedidos(Pedido As Long)
   ...
   If rPc("numero") = 1 And CInt(ValidateNull(rPc("status"))) = 1 Then
      frEnt.Mostrar = True
   Else
      frEnt.Mostrar = False
   End If
   ...
   txtCidade.Caption = ValidateNull(rCl("cidade")) & "-" & ValidateNull(rCl("estado")) & " TEL: " & ValidateNull(rCl("telefone1"))
