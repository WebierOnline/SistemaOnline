...
Begin VB.Form Promissoria 
   ...
   Begin ChamaleonBtn.chameleonButton cmdFechar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Promissoria.frx":8742
      PICN            =   "Promissoria.frx":875E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdImprimir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Promissoria.frx":8A78
      PICN            =   "Promissoria.frx":8A94
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub cboCliente_Click()
   ...
   If cboPedido.ListCount > 0 Then cboPedido.ListIndex = 0
End Sub
...
Private Sub cboPedido_Click()
   ...
   sSQL = "SELECT * FROM parcelas INNER JOIN pedidos ON parcelas.cod_pedido = pedidos.cod_pedido " & _
      "WHERE (pedidos.pagamento = 'Promissoria') AND (pedidos.cod_pedido = " & Pedido & ");"
