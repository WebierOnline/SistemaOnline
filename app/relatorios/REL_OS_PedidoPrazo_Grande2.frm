...
Begin VB.Form REL_OS_PedidoPrazo_Grande2 
   ClientHeight    =   8790
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13170
   ...
   Begin ReportX.ReportSection ReportSection4 
      ...
      Begin VB.Image Image1 
         Height          =   3510
         Left            =   900
         Picture         =   "REL_OS_PedidoPrazo_Grande2.frx":0000
         Stretch         =   -1  'True
         Top             =   240
         Width           =   1275
      End
   ...
   End
End
Attribute VB_Name = "REL_OS_PedidoPrazo_Grande2"
...
'End If
   ...
   Else
      If rPd("tipo_desc") = "R" Then
         wValorFormatado = Format(rOs("valor_desc"), ocMONEY)
      Else
         wValorFormatado = FormatNumber(rOs("valor_desc"), 2) & "%"
      End If
   End If

   txtDesconto.Caption = wValorFormatado
  
   txtTotal.Caption = String(1, " ") + Format(rOs("total"), ocMONEY)
