...
Begin VB.Form REL_Viagem_Reserva 
   ...
   ClientTop       =   330
   ClientWidth     =   16260
   Icon            =   "REL_Viagem_Reserva.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   62.177
   ...
   Begin VB.Image Image2 
      Height          =   1650
      Left            =   0
      Picture         =   "REL_Viagem_Reserva.frx":030A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1725
   End
End
Attribute VB_Name = "REL_Viagem_Reserva"
