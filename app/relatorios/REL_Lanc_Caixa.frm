...
Begin VB.Form REL_Lanc_Caixa 
   ...
   Begin ReportX.ReportSection ReportSection3 
      ...
      _ExtentY        =   1614
      Tipo            =   7
      Begin ReportX.ReportField dfSaldo 
         Height          =   195
         Left            =   3240
         TabIndex        =   10
         Top             =   60
      ...
      Begin ReportX.ReportField dfData 
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfRelSaldo 
         Height          =   195
         Left            =   10140
         TabIndex        =   22
         Top             =   60
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfRelData 
         Height          =   195
         Left            =   9000
         TabIndex        =   23
         Top             =   60
   ...
   Begin VB.Image Image2 
      Height          =   1650
      Left            =   0
      Picture         =   "REL_Lanc_Caixa.frx":030A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1725
   End
End
Attribute VB_Name = "REL_Lanc_Caixa"
