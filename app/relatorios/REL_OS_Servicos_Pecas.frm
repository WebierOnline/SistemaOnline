...
Begin VB.Form REL_OS_Servicos_Pecas 
   ...
   ClientTop       =   330
   ClientWidth     =   12570
   Icon            =   "REL_OS_Servicos_Pecas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   66.41
   ...
   Begin ReportX.ReportSection ReportSection3 
      ...
      Begin ReportX.ReportField ReportField6 
         ...
         EndProperty
      End
      Begin ReportX.ReportField dfQuantOS 
         Height          =   270
         Left            =   900
         TabIndex        =   12
         Top             =   45
      ...
      Begin ReportX.ReportField dfTotalOS 
         ...
         Borda           =   15
      End
      Begin ReportX.ReportField dfQuantVenda 
         Height          =   270
         Left            =   3780
         TabIndex        =   28
         Top             =   45
         ...
         Borda           =   15
      End
      Begin ReportX.ReportField dfTotalVenda 
         Height          =   270
         Left            =   4260
         TabIndex        =   29
         Top             =   45
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      Begin VB.Label lblTitulo 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "RELATÓRIO DE SERVIÇOS E PEÇAS"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   14.25
            Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   1650
      Left            =   0
      Picture         =   "REL_OS_Servicos_Pecas.frx":030A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1725
   End
End
Attribute VB_Name = "REL_OS_Servicos_Pecas"
