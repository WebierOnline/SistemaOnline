# -*- coding: utf-8 -*-
"""
Remove os blocos de controle Frame2, Grid (bare), lblQuant, lblTotalConsulta
de OS_Recapadora.frm (movidos para OS_Consulta.frm).
"""
...
# cada bloco removido tira 1 Begin e 1 End "bare" do topo, mas Frame2 tem filhos
# com seus proprios Begin/End aninhados tambem removidos junto - a diferenca
# total de Begin removidos deve ser igual a diferenca de End removidos
