...
INSERT INTO [dbo].[tbISClassTrib]
    ([cClassTrib_IS], [Descricao],                          [tipo_calculo_is], [ISpAliq], [ISvUnid], [dIniVig],    [dFimVig])
VALUES
    ('900001', 'Vinhos, Espumantes e Cachaças',              1,  20.00, NULL,   '2026-01-01', '2026-12-31'),
    ('900002', 'Cervejas e Chopes',                          1,  20.00, NULL,   '2026-01-01', '2026-12-31'),
    ('900003', 'Destilados (Uísque, Gin, Vodka)',            1,  20.00, NULL,   '2026-01-01', '2026-12-31'),
    ('900010', 'Refrigerantes e Sucos com Adição de Açúcar', 2,  NULL,  0.10,   '2026-01-01', '2026-12-31'),
    ('900011', 'Energéticos e Bebidas Esportivas',           2,  NULL,  0.10,   '2026-01-01', '2026-12-31'),
    ('900020', 'Veículos Autopropulsados (poluentes)',        1,   7.50, NULL,   '2026-01-01', '2026-12-31'),
    ('900040', 'Produtos do Fumo (Cigarros e derivados)',    3,  100.00, 0.50,   '2026-01-01', '2026-12-31');
