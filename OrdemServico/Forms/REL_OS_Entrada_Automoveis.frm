...
Begin VB.Form REL_OS_Entrada_Automoveis 
   ...
   ClientTop       =   330
   ClientWidth     =   12075
   Icon            =   "REL_OS_Entrada_Automoveis.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   162.19
   ...
   Begin ReportX.ReportSection ReportSection1 
      ...
      Begin ReportX.ReportField rfEquipamento 
         ...
         AlinhamentoVertical=   2
      End
      Begin ReportX.ReportField txtPlaca1 
         Height          =   420
         Left            =   180
         TabIndex        =   36
         Top             =   4020
      ...
      Begin ReportX.ReportField ReportField17 
         ...
         AlinhamentoVertical=   2
      End
      Begin ReportX.ReportField txtTanque 
         Height          =   420
         Left            =   4620
         TabIndex        =   40
         Top             =   4020
      ...
      Begin ReportX.ReportField txthead 
         ...
         _ExtentX        =   15849
         _ExtentY        =   794
         Caption         =   "ORDEM DE SERVIÇO - ENTRADA"
         Alignment       =   2
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   18
   ...
   End
End
Attribute VB_Name = "REL_OS_Entrada_Automoveis"
...
i = 0
Do While Not r2.EOF
   If i < 5 Then lblSituacao(i).Caption = r2("Situacao")
   i = i + 1
   r2.MoveNext
Loop
