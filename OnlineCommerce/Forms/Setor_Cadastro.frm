...
Begin VB.Form Setor_Cadastro 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.Image Image1 
         Height          =   645
         Left            =   300
         Picture         =   "Setor_Cadastro.frx":23D2
         Top             =   0
         Width           =   735
      End
   ...
   Begin ChamaleonBtn.chameleonButton cmdCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Setor_Cadastro.frx":8742
      PICN            =   "Setor_Cadastro.frx":875E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Setor_Cadastro.frx":A4F0
      PICN            =   "Setor_Cadastro.frx":A50C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Setor_Cadastro.frx":C29E
      PICN            =   "Setor_Cadastro.frx":C2BA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Setor_Cadastro.frx":E04C
      PICN            =   "Setor_Cadastro.frx":E068
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Setor_Cadastro.frx":FDFA
      PICN            =   "Setor_Cadastro.frx":FE16
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Setor_Cadastro"
