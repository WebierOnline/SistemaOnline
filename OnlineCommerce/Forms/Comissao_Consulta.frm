...
Begin VB.Form Comissao_Consulta 
   ...
   ClientTop       =   330
   ClientWidth     =   13215
   Icon            =   "Comissao_Consulta.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9945
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirPedidos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Comissao_Consulta.frx":23D2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.Frame frmFiltro1 
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalendario2 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "Comissao_Consulta.frx":23EE
               PICN            =   "Comissao_Consulta.frx":240A
               PICH            =   "Comissao_Consulta.frx":475D
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin ChamaleonBtn.chameleonButton cmdCalendario1 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "Comissao_Consulta.frx":6AB0
               PICN            =   "Comissao_Consulta.frx":6ACC
               PICH            =   "Comissao_Consulta.frx":8E1F
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
            ...
            Begin ChamaleonBtn.chameleonButton cmdCal1 
               ...
               MCOL            =   12632256
               MPTR            =   1
               MICON           =   "Comissao_Consulta.frx":B172
               PICN            =   "Comissao_Consulta.frx":B18E
               PICH            =   "Comissao_Consulta.frx":D4E1
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdLocalizar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Comissao_Consulta.frx":F834
         PICN            =   "Comissao_Consulta.frx":F850
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdSair 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Comissao_Consulta.frx":1012A
         PICN            =   "Comissao_Consulta.frx":10146
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonBtn.chameleonButton cmdImprimir 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Comissao_Consulta.frx":10460
         PICN            =   "Comissao_Consulta.frx":1047C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox picAguarde 
      ...
      Height          =   1095
      Left            =   4740
      Picture         =   "Comissao_Consulta.frx":10796
      ScaleHeight     =   1095
      ScaleWidth      =   2895
      TabIndex        =   10
      Top             =   5820
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   585
         Left            =   240
         Picture         =   "Comissao_Consulta.frx":117CE
         Stretch         =   -1  'True
         Top             =   0
         Width           =   900
      End
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirProdutos 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Comissao_Consulta.frx":18014
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExibirParcelas 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Comissao_Consulta.frx":18030
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Comissao_Consulta"
...
DoEvents
   ...
   End With
    ...
    'lblDesc.Caption = Format(SomaGrid(Grid, 5), ocMONEY)
