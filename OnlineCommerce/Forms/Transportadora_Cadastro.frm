...
Begin VB.Form Transportadora_Cadastro 
   ...
   ClientTop       =   435
   ClientWidth     =   9390
   Icon            =   "Transportadora_Cadastro.frx":0000
   LinkTopic       =   "Form49"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7695
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "Transportadora_Cadastro.frx":23D2
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "frm_Secundario"
      Tab(0).Control(1)=   "frm_Principal"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "CONSULTA"
      TabPicture(1)   =   "Transportadora_Cadastro.frx":23EE
      ...
      Begin VB.Frame frm_Principal 
         ...
         Begin VB.ComboBox cboEstado 
            Height          =   315
            ItemData        =   "Transportadora_Cadastro.frx":240A
            Left            =   1920
            List            =   "Transportadora_Cadastro.frx":240C
            TabIndex        =   12
            Top             =   2580
            Width           =   795
         End
         Begin VB.ComboBox cboCidade 
            Height          =   315
            ItemData        =   "Transportadora_Cadastro.frx":240E
            Left            =   120
            List            =   "Transportadora_Cadastro.frx":2410
            TabIndex        =   11
            Top             =   2580
            Width           =   1755
         End
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   300
         Picture         =   "Transportadora_Cadastro.frx":2412
         Top             =   0
         Width           =   900
      End
   End
   Begin ChamaleonBtn.chameleonButton cmdSalvar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":5206
      PICN            =   "Transportadora_Cadastro.frx":5222
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   4
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdAlterar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":BAEC
      PICN            =   "Transportadora_Cadastro.frx":BB08
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdNovo 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":C3E2
      PICN            =   "Transportadora_Cadastro.frx":C3FE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":D0D8
      PICN            =   "Transportadora_Cadastro.frx":D0F4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   4
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdExcluir 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":13B98
      PICN            =   "Transportadora_Cadastro.frx":13BB4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonBtn.chameleonButton cmdSair 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Transportadora_Cadastro.frx":13ECE
      PICN            =   "Transportadora_Cadastro.frx":13EEA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "transportadora_Cadastro"
...
Private Function Inserir_Dados() As Boolean
   ...
   'Não se deve comparar se o campo está vazio ou não, pois não
   ...
   sSQL = "INSERT INTO transportadora (" & _
      "codigo, razao, endereco, ponto_de_referencia, telefone, cidade, estado, cnpj, " & _
